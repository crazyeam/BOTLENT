...
const config = {
    A187: 'Asep-IT',
    instagram: 'https://instagram.com/barbarjancok37',
    nomer: 'wa.me/6285860322056',
    aktif: '24 JAM',
...
client.on('message-status-update', json => {
   ...
   console.log(`[ ${time} ] => bot by ig:barbarjancok37`)
})
   ...
   case 'bitly':
    ...
    case 'bucin':
     ...
     case 'cooltext':
           ...
           break
          case 'creator':
            client.sendContact(from, '6285860322056@c.us')
            break
      case 'tts':
